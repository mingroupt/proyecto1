...
if( $settings->getSetting('user.support.links', 0) == 1 ) {
	echo 'More info: <a href="http://derefer.me/?http://support.socialengine.com/questions/123/Admin-Panel-Layout-File-Media-Manager" target="_blank">See KB article</a>';	
} 
?>	
<br />	
