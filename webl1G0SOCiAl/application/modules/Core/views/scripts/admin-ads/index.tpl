...
<p>
  ...
  <a class="admin help" href="http://derefer.me/?http://support.socialengine.com/questions/161/Admin-Panel-Ads" target="_blank"> </a>
</p>
<?php
$settings = Engine_Api::_()->getApi('settings', 'core');
if( $settings->getSetting('user.support.links', 0) == 1 ) {
	echo 'More info: <a href="http://derefer.me/?http://support.socialengine.com/questions/161/Admin-Panel-Ads" target="_blank">See KB article</a>.';	
} 
?>	
