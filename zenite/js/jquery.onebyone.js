...
;(function($) {	
    ...
    $.fn.oneByOne = function(options) {  
		...
		//parent.css('overflow', 'hidden') //mostro l'animacio per fora
		...
		_this.find('.'+settings.sliderClassName).each(function(index) { 
			...
			*/                                                                                                  
 			$(this).hide();																					
			bannerNum++;		
			 $(this).css('left', bannerWidth*index)     //----------------------------------------------------  MODIFICAT
		...
		parent.mouseleave(function (event){
			//if(buttonCon)buttonCon.fadeOut(); //no permeto que soculti el boto
			//if(arrowButton)arrowButton.fadeOut(); //no permeto que socultin les fletxes
		...
		if(settings.showButton){
            buttonArea = $('<div class="buttonArea"><div class="linealeft"></div><div class="buttonCon"></div><div class="linearight"></div></div>');
			// buttonArea.hide();
		...
		//no permerto que s'ocultin els navegadors
