    ...
    <body class="my-body">
        ...
        <div id="gallery-detail-page" class="page" data-theme="a" data-role="page">
            ...
            <div class="ui-body margpage">
                <center>
                <h1 class="mini">1 Column [<a href="javascript:window.location = window.location;">Refresh?</a>]</h1>
                </center>
                ...
                <div class="gallery-items" data-columns="1">
                    ...
                    <div class="container hide group">
                        <ul>
                                                            <li>
                                    <a href="images/gallery/image2.jpg" class="item image" data-ajax="false">
                                        <img src="images/gallery/image2.jpg" alt="Photo 1" />
                                    </a>
                                </li>
                                                            <li>
                                    <a href="images/gallery/image3.jpg" class="item image" data-ajax="false">
                                        <img src="images/gallery/image3.jpg" alt="Photo 2" />
                                    </a>
                                </li>
                                                            <li>
                                    <a href="images/gallery/image4.jpg" class="item image" data-ajax="false">
                                        <img src="images/gallery/image4.jpg" alt="Photo 3" />
                                    </a>
                                </li>
                                                            <li>
                                    <a href="images/gallery/image5.jpg" class="item image" data-ajax="false">
                                        <img src="images/gallery/image5.jpg" alt="Photo 4" />
                                    </a>
                                </li>
                                                    </ul>
