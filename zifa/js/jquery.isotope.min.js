...
/*global Modernizr: true, jQuery: true */ (function (a, b, c) {
    "use strict";
    var d = function (a) {
    ...
    b.Isotope.settings = {
        ...
        _create: function (a) {
            ...
            }, 0), this.options.resizable && r.bind("smartresize.isotope", function () {
                h.resize()
        ...
        destroy: function () {
            ...
            this.$allAtoms.removeClass(b.hiddenClass + " " + b.itemClass).each(function () {
                var b = this.style;
                b.position = "", b.top = "", b.left = "", b.opacity = "", a && (b[g] = "")
            });
            var c = this.element[0].style;
            for (var d = 0, e = q.length; d < e; d++) {
                var f = q[d];
            ...
            this.element.unbind(".isotope").undelegate("." + b.hiddenClass, "click").removeClass(b.containerClass).removeData("isotope"), r.unbind(".isotope")
        },
    ...
    b.fn.isotope = function (a, c) {
        if (typeof a == "string") {
            ...
            this.each(function () {
                ...
                if (!c) s("cannot call methods on isotope prior to initialization; attempted to call method '" + a + "'");
                else {
                    if (!b.isFunction(c[a]) || a.charAt(0) === "_") {
                        s("no such method '" + a + "' for isotope instance");
                        return
                    }
                    c[a].apply(c, d)
                }
